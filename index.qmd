...
**Session type:** [In Person]{.in-person} \| [Off-line]{.off-line} \| [Demo + Studio]{.demo} \| [Studio]{.studio} \| [Presentations]{.presentation} \| [No Class]{.no-class}
...
### [August 27, September 1]{.in-person} R Review --- and Your First Interactive Map
...
-   The grammar of `ggplot2`: scatterplots, line graphs, facets
-   Simple features and the `sf` package; shapefiles and their component files
-   John Snow, 1854: the first spatial epidemiology
-   Your first map: `geom_sf()`; colour scales and what makes one defensible
-   Maps in layers: points over polygons; joining a data table to a boundary file
...
-   [GITHUB Link](https://BSTA-374.github.io/RreviewAndMaps/)

### [September 3,8]{.in-person} Thematic Cartography
...
-   [GITHUB Link](https://BSTA-374.github.io/thematicMapping/)

### [September 8, 10]{.in-person} Version Control with Git & GitHub
...
-   [GITHUB Link](https://BSTA-374.github.io/github/)
...
-   [GITHUB Link](https://bsta-374.github.io/pointpattern/)
...
-   (if time allows) Introduction to Exercise 3 *(worked on over Weeks 4--5)*
-   [GITHUB Link]((https://BSTA-374.github.io/space-timePointPattern/))
...
### [October 13]{.off-line} Cluster Detection
