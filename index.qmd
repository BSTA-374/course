...
### [August 27]{.in-person} R Review --- and Your First Interactive Map
...
-   Your first map: `geom_sf()`, then an interactive one with `mapview` and `leaflet`
-   In-class exercise: a short self-check --- if any of it is unfamiliar, come see me this week
-   Software setup: R, RStudio, `sf`, Git & GitHub
